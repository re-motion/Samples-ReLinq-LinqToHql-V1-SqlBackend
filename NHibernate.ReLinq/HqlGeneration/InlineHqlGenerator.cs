...
{
  public class InlineHqlGenerator : HqlGenerator
  {
    private readonly CommandBuilder _fixedCommandBuilder;

    public InlineHqlGenerator (
        IDatabaseInfo databaseInfo, CommandBuilder fixedCommandBuilder, ParseMode parseMode)
    ...
    {
      return new HqlGenerationContext (_fixedCommandBuilder);
    }
  }
}